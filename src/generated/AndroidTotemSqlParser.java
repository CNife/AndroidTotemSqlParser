...
public class AndroidTotemSqlParser implements AndroidTotemSqlParserConstants {
   ...
   */
  static public AndroidTotemSqlParserTokenManager token_source;
  /**
   * Current token.
   */
  ...
  static public void ReInit(java.io.InputStream stream, String encoding) {
    ...
    AndroidTotemSqlParserTokenManager.ReInit(jj_input_stream);
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
    for (int i = 0; i < 1; i++) jj_la1[i] = -1;
  ...
  static private Token jj_consume_token(int kind) throws ParseException {
    ...
    else token = token.next = AndroidTotemSqlParserTokenManager.getNextToken();
    jj_ntk = -1;
    if (token.kind == kind) {
      jj_gen++;
      trace_token(token, "");
  ...
  static final public Token getToken(int index) {
    ...
    for (int i = 0; i < index; i++) {
      ...
      else t = t.next = AndroidTotemSqlParserTokenManager.getNextToken();
    }
    return t;
  }
  ...
  static private int jj_ntk_f() {
    if ((jj_nt = token.next) == null)
      return (jj_ntk = (token.next = AndroidTotemSqlParserTokenManager.getNextToken()).kind);
    else
